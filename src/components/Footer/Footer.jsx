    ...
    return (
        <div>
            ...
            <div className={styles.contactInformation}>
                ООО "ТРЕНД-СОФТ", ОГРНИП 3323523523, ИНН 234234234 <br/>
                Україна, Київ, вул. Степана Бандери, 24, буд. 2 <br/>
            </div>
        </div>
    );
}
